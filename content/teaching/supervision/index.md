...
To register your project on the platform of the University of Malaga you must fill in the following information (that can be sent to me via _Teams_). All the data must be submitted to the platform as plain text, so please, send it to me in this format, do not prepare a formatted document.
